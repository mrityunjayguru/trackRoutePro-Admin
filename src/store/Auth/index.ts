...
export const authDataSlice = createSlice({
  ...
  reducers: {
    ...
    checkExistingUsers: (state, action: PayloadAction<any>) => {
      state.existingUser = action.payload; // Set user table data
    },
    clearUserData: (state) => {
...
// Export actions
export const { setLoginUserData, setUserTableData, clearUserData,checkExistingUsers } = authDataSlice.actions;
