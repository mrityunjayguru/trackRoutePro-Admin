...
import { singleDelearSubscribers, singleSubscribers } from '../../../../api/users';
        ...
        <div className="flex gap-20">
          ...
          <div className='flex gap-1 items-center'>
            ...
            <div>
              <p className="text-[#D9E821] cursor-pointer flex justify-center items-center">
                <FaEye style={{ fontSize: '24px' }} onClick={()=>manageUsercontact(sibglesubscriber)} />
              </p>
            </div>
          </div>
          ...
          {sibglesubscriber?.dealerdetail && (
            ...
            <p className="text-sm font-normal text-[#9F9EA2]">Dealer Code</p>
              ...
              <div>
              <p className="text-[#D9E821] cursor-pointer flex justify-center items-center">
                <FaEye style={{ fontSize: '24px' }}  onClick={()=>manageDelearcontact(sibglesubscriber?.dealerdetail)}/>
              </p>
            </div>
            </div>
          )}
