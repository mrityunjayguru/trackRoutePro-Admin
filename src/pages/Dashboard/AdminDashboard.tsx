  ...
  return (
    ...
    {toggle?(<Loader/>):(null)}
      <div className="grid grid-cols-1 sm:grid-cols-1 text-xl font-semibold text-black dark:text-white md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-5   justify-between px-3">
        ...
        <CardDataStats
          title="Subscriptions Expiring in Next 15 Days"
          total={dashboard.subscriberExp}
          rate=""
          color="#FE5513"
          text="#ffffff"
          style={{ position: 'absolute', bottom: '0',paddingbottom:'20px'}}
        >
          <svg
            className="fill-primary dark:fill-white"
            width="22"
        ...
        <CardDataStats
          text="#ffffff"
          title="Total Number of Alerts Till Today"
          total={dashboard.notificationCount}
          rate=""
          color="#02B754"
          style={{ position: 'absolute', bottom: '0',paddingbottom:'20px'}}
        ...
        <CardDataStats
          text="#02B754"
          title="Admin Roles"
          total={dashboard.adminRoleCount}
          rate=""
          levelDown
           color="#F0F4FD"
          style={{ position: 'absolute', bottom: '0',paddingbottom:'20px',paddning:"10px"}}

        // This will give it less width
        >
          <svg
            className="fill-primary dark:fill-white"
            width="22"
