...
import { Permission, PermissionModerate, PermissionOperator } from "../../../layout/Permision";

function Operator({ permissions, setPermissions }: { permissions: any; setPermissions: (updated: any) => void }) {
