      ...
      <div className="rounded-sm  xl:pb-1">
        <table className="w-full table-auto text-left">
          <thead className="bg-[#F0F4FD] text-gray-700">
            <tr className="grid grid-cols-7 gap-4 font-semibold text-center text-base">
          ...
          <tbody>
            {AdminData && AdminData.length > 0 ? (
              AdminData.map((user: any, i: number) => (
                <tr
                key={user._id}
                className={`grid grid-cols-7 gap-4 text-center border-b border-stroke text-[15px] font-medium ${
              ...
              >
                  ...
                  <td className="p-1">{user.emailAddress}</td>
