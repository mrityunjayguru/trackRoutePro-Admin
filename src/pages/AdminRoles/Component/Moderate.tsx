...
import { Permission, PermissionModerate } from "../../../layout/Permision";

function Moderate({ permissions, setPermissions }: { permissions: any; setPermissions: (updated: any) => void }) {
