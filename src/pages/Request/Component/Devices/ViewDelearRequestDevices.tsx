...
import { ViewDeviceKeysRequest } from '../../../../Utility/FolmKeys/Devices/DelearRequest/ViewDeviceKey';
...
const ViewDelearRequestDevices = () => {
  ...
  const handleSubmit = async () => {
    navigate('/support/dealers/Edit-Devices');
  };
...
export default ViewDelearRequestDevices;
