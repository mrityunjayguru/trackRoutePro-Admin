...
import { editDeviceKeysRequest } from '../../../../Utility/FolmKeys/Devices/DelearRequest/editDeviceKeys';

const EditDelearRequestDevices = () => {
  ...
  const singleUserDevice = useSelector(
  ...
  useEffect(() => {
    if (
      loginUser.permissions?.Device?.Update === false &&
  ...
  const handleSubmit = async (val: any) => {
    ...
    if (payload.displayParameters && Array.isArray(payload.displayParameters)) {
      const displayParametersObject = payload.displayParameters.reduce(
  ...
  const PropsRecord = {
    ...singleUserDevice.ownerIDDetail,
    ...singleUserDevice,
  };
  return (
...
export default EditDelearRequestDevices;
