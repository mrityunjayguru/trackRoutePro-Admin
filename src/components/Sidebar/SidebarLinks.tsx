  ...
  return [
    {
      ...
      isView:  loginUser.role === "SuperAdmin" || loginUser.role === "Admin" ? true : false , // Added the isView property
    },
    {
    ...
    },
    {
      ...
      isView: loginUser.role=="SuperAdmin" || loginUser?.permissions?.Map?.View?true:false, // Added the isView property
    },
    {
      path: '/notifications',
      label: 'Notifications',
      ...
      isView: loginUser.role === "SuperAdmin" || loginUser.role === "Admin" ? true : false, // Corrected condition
    },
    
  {
    ...
    children: [
      { 
        ...
        icon: '',
        isView: loginUser.role=="SuperAdmin" || loginUser?.permissions?.Support?.View?true:false, // Added the isView property
        condition: (pathname: string) => pathname.includes('account-management'),
      },
      { 
