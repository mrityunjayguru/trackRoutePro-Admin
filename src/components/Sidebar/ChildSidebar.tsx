...
import { useChildSidebarRoutes } from './sidebarLinks/ChildSidebarlink';
...
const ChildSidebar: React.FC<SidebarProps> = ({ sidebarOpen }) => {
  const { pathname } = useLocation();
  const sidebarRoutes = useChildSidebarRoutes();
